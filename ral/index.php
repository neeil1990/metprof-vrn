...
$APPLICATION->SetTitle("RAL");
?>

<?$APPLICATION->IncludeComponent("bitrix:news", "ral", Array(
    ...
    "CATALOG_IBLOCK_ID" => "24",	// Инфоблок Каталог
    ...
    "SEF_FOLDER" => "/ral/",	// Каталог ЧПУ (относительно корня сайта)
