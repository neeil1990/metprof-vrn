<?if(!$is_main && $pages[1] !== 'basket' && !($pages[1] == 'catalog' && $pages[3])){?>				</div><!--end::page_content-->
				<?}?>
				<footer>
					...
					<div class="footer__bottom cl">
						<div class="footer__copyright">© 2006 — <?=date("Y");?>. Металлинвест Профиль. Воронеж</div>
<!--
...
(function(){ var widget_id = '9blAmUrWYa';var d=document;var w=window;function l(){
...
<noscript><div><img src="https://mc.yandex.ru/watch/48970379" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
